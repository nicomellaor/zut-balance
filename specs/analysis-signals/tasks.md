...
- [x] 1. Reemplazar el dominio narrativo por modelos y generador puro de señales.
...
- [x] 5. Adaptar mínimamente la vista de análisis y dashboard.
...
- [x] 6. Actualizar E2E y ejecutar regresión completa.
...
- [x] 7. Actualizar documentación y verificar la fase.
